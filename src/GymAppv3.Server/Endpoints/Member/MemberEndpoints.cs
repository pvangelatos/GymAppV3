...
using GymAppv3.Server.Endpoints.Member.Bookings;
using GymAppv3.Server.Endpoints.Member.Memberships;
...
public static class MemberEndpoints
{
    public static IEndpointRouteBuilder MapMemberEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        // Register member-scoped booking endpoints
        app.MapMemberBookingEndpoints();

        // Register member-scoped membership endpoints
        app.MapMemberMembershipEndpoints();
